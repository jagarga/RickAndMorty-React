# React Webpack Typescript Redux Sagas React Router Axios Material UI Template
...
- **[Redux Sagas](https://www.https://redux-saga.js.org/)** (1.x)
- **[Redux Router Dom](https://www.hhttps://reactrouter.com/)** (6.x)
